        ...
        <table>
            <thead >
                ...
                <tr>
                    ...
                    <th colspan="2" style="font-weight:700; text-align:center; padding:5px">{{ trans('app.changing rate of banks') }}</th>
                ...
                @endphp
                    @foreach ($reports as $item)
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; color:{{ ($cash->color=='#000')?'':$cash->color }}">
                                {{ number_format($cash->final_result, 2) }}
                            </td>
                            <td style="text-align: center; color:{{ $business->color=='#000'?'':$business->color }}">
                                {{ number_format($business->final_result, 2) }}
                            </td>
                            <td style="text-align: center; color:{{ ($inspeksiya->color=='#000')?'':$inspeksiya->color }}">
                                {{ number_format($inspeksiya->final_result, 2) }}
                            </td>
                            <td style="text-align: center; color:{{ $currency->color=='#000'?'':$currency->color }}">
                                {{ number_format($currency->final_result, 2) }}
                            </td>
                            <td style="text-align: center; color:{{ $ijro->color=='#000'?'':$ijro->color }}">
