    ...
    <div class="app-container page-sign-up">
        <div class="content-box">
            <div class="content-header">
                <div class="app-logo">
                    <div class="logo-wrap"><img src="../assets/img/logo.png" alt="" width="147" height="33" class="logo-img" /></div>
                </div>
            </div>
            <div class="content-body">
                <div class="w-100">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input id="middlename" type="text" placeholder="Middle name" class="form-control @error('middlename') is-invalid @enderror" name="middlename" value="{{ old('middlename') }}" required autocomplete="middlename" autofocus>
                            @error('middlename')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="actions justify-content-between">
                            <button type="submit" class="btn btn-primary"><span class="btn-icon icofont-plus mr-2"></span>Ro'yxatdan o'tish </button>
                        </div>
                    </form>
                </div>
            </div>
