            ...
            <table>
                <thead>
                    ...
                    <tr>
                        ...
                        <th rowspan="2" width='15%'>{{ trans('app.banks') }}</th>
                        <th rowspan="2" width='5%'>{{ trans('app.mfo id') }}</th>
                        <th width='14%'>{{ trans('app.average rating of banks') }}</th>
                        <th colspan="2" width='15%'>{{ trans('app.changing rate of banks') }}</th>
                        <th width='13%'>
                    ...
                    @endphp
                        @foreach ($reports as $item)
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; color:{{ $tushum->color }}">
                                    {{ number_format($tushum->final_result, 2) }}
                                </td>
                                <td style="text-align: center; color:{{ $qaytish->color }}">
                                    {{ number_format($qaytish->final_result, 2) }}
                                </td>
                                <td style="text-align: center; color:{{ $m_report->color }}">
                                    {{ number_format($m_report->final_result, 2) }}
                                </td>
                                <td style="text-align: center; color:{{ $execution->color }}">
