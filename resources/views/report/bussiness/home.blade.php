                        ...
                        <table id="myTable" class="table table-striped table-lightfont">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" width='15%'>{{ trans('app.mfo id') }}</th>
                                    <th rowspan="2" width='15%'>{{ trans('app.average rating of banks') }}</th>
                                    <th colspan="6" width="50%" style="text-align: center">{{ trans('app.from') }}</th>
                                </tr>
                                <tr>
                                    <th>{{ trans('app.credit 50') }}</th>
                                    <th>{{ trans('app.credit 50-60') }}</th>
                                    <th>{{ trans('app.credit 60-70') }}</th>
                                    <th>{{ trans('app.credit 70-80') }}</th>
                                    <th>{{ trans('app.credit 80-90') }}</th>
                                    <th>{{ trans('app.credit 90-100') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(!empty($reports))
                                    ...
                                    @foreach ($reports as $item)
                                        ...
                                        <tr id="{{ generateMfo($item->mfo_id) }}">
                                            ...
                                            <td style="text-align: center">{{ (count((array) $array_filter) > 1)?number_format(($data->credit_80_90), 0, '.', ','):'' }}</td>
                                            <td style="text-align: center">{{ (count((array) $array_filter) > 1)?number_format(($data->credit_90_100), 0, '.', ','):'' }}</td>
                                        </tr>
                                        @php
                                            $i++;
                                        @endphp
