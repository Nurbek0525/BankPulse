                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-striped table-lightfont">
                            <thead>
                                ...
                                <tr>
                                    <th class="color-black">{{ trans('app.credit approved not given') }}</th>
                                    <th class="color-black">{{ trans('app.product delivered not credit given') }}</th>
                                    <th class="color-black">{{ trans('app.money exist credit not given') }}</th>
                                    <th class="color-black">{{ trans('app.credit given in wrong way') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(!empty($reports))
