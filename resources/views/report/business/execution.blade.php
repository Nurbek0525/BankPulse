        ...
        <div class="content-box">
            <div class="element-wrapper">
                <div class="element-box">
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="/report/business/execution/table" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <tbody>
                                @if(!empty($reports))
                                    ...
                                    @foreach ($reports as $item)
                                        @php
                                            $data = json_decode($item->b_execution);
                                            ...
                                            if(count((array) $array_filter) > 1){
                                                ...
                                                $rate = ($exist_case - ($poor_quality+$delayed+$not_provided))*($weight->b_execution/100);
                                            }else{
                                                $exist_case = 0;
                                                $poor_quality = 0;
                                                $delayed = 0;
