        ...
        <div class="content-box">
            <div class="element-wrapper">
                <div class="element-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="/report/final/table" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <table id="myTable" class="table table-striped table-lightfont">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" width='8%'>{{ trans('app.mfo id') }}</th>
                                    <th  width='6%'>{{ trans('app.average rating of banks') }}</th>
                                    <th colspan="2" width='11%'>{{ trans('app.changing rate of banks') }}</th>
                                    <th rowspan="2" width="4%" style="text-align: center;  padding: 40px 5px 10px 5px;">
                                ...
                                <tr>
                                    @if(!empty($weight))
                                        ...
                                        <th>{{ $weight->cash }}%
                                            <a class="sort_href" href="/report/cash/table{{ (!empty($monthyear))?'?monthyear='.$monthyear:'' }}">
                                                <span class="os-icon os-icon-zoom-in table-icon-color"></span>
                                            </a>
                                        </th>
                                        <th>{{ $weight->business }}%
                                            <a class="sort_href" href="/report/business/table{{ (!empty($monthyear))?'?monthyear='.$monthyear:'' }}">
                                                <span class="os-icon os-icon-zoom-in table-icon-color"></span>
                                            </a>
                                        </th>
                                        <th>{{ $weight->inspeksiya }}%
                                            <a class="sort_href" href="/report/inspeksiya/table{{ (!empty($monthyear))?'?monthyear='.$monthyear:'' }}">
                                                <span class="os-icon os-icon-zoom-in table-icon-color"></span>
                                            </a>
                                        </th>
                                        <th>{{ $weight->currency }}%
                                            <a class="sort_href" href="/report/currency/table{{ (!empty($monthyear))?'?monthyear='.$monthyear:'' }}">
                                                <span class="os-icon os-icon-zoom-in table-icon-color"></span>
                                            </a>
                                        </th>
                                        <th>{{ $weight->ijro_head }}%
