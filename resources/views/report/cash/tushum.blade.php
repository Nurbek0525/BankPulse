        ...
        <div class="content-box">
            <div class="element-wrapper">
                <div class="element-box">
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="/report/cash/tushum/table" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <table id="myTable" class="table table-striped table-lightfont">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" width='25%'class="color-black" style="text-align: center">{{ trans('app.banks') }}</th>
                                    <th rowspan="2" width='10%'class="color-black" style="text-align: center">{{ trans('app.mfo id') }}</th>
                            ...
                            <tbody>
                                @if(!empty($reports))
                                    ...
                                    @foreach ($reports as $item)
                                        @php
                                            $data = json_decode($item->cash_tushum);
                                        ...
                                        <tr>
                                            ...
                                            <td class="amount">{{ (!empty($data->averageyear))?number_format($data->averageyear, 0, '.', ' '):0 }}</td>
                                            <td class="amount">{{ (!empty($data->lastyearthismonth))?number_format($data->lastyearthismonth, 0, '.', ' '):0 }}</td>
                                            <td class="amount">{{ (!empty($data->lastmonth))?number_format($data->lastmonth, 0, '.', ' '):0 }}</td>
                                            <td class="amount">{{ (!empty($data->thismonth))?number_format($data->thismonth, 0, '.', ' '):0 }}</td>
                                        </tr>
                                        @php
                                            $i++;
                                        @endphp
