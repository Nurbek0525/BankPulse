        ...
        <div class="content-box">
            <div class="element-wrapper">
                <div class="element-box">
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="/report/cash/execution/table" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <tbody>
                                @if(!empty($reports))
                                    ...
                                    @foreach ($reports as $item)
                                        @php
                                            $data = json_decode($item->cash_execution);
                                            $rate = !empty($data->exist_case)?(($data->exist_case - ($data->not_provided + $data->poor_quality + $data->delayed))/$data->exist_case):0;
                                            $rate = $rate*$weight->cash_execution;
