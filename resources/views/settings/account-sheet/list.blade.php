                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="text-align: right;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <a href="/settings/account-sheet/add" class="btn btn-primary btn-square excel-button">
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped table-lightfont">
                                    <thead>
                                        <tr>
                                            <th width='5%'>#</th>
                                            <th width="10%">{{ trans('app.account sheet account id') }}</th>
                                            <th width="50%">{{ trans('app.account name') }}</th>
