                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="text-align: right;">
                            <div class="row">
                                <div class="col-md-6">
                                   <div class="form-group">
                                    <a href="/settings/loan-goal/add" class="btn btn-primary btn-square excel-button">
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-striped table-lightfont">
                            <thead>
                                <tr>
                                    <th width='3%'>#</th>
                                    <th width="10%">{{ trans('app.loan goal code') }}</th>
                                    <th width='50%'>{{ trans('app.loan goal name') }}</th>
